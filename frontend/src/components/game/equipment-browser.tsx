...
function matchesChosungSearch(text: string, query: string): boolean {
  ...
  if (isChosungQuery) {
    const textChosung = [...text]
      .map((c) => getChosung(c) ?? c)
      .join("");
...
const EQUIPMENT_ITEMS: EquipmentItem[] = [
  // 무기
  { code: "S_sword", name: "검", category: "weapon", cost: 100, reqSecu: 0, attack: 1, info: "기본 검" },
  { code: "S_spear", name: "창", category: "weapon", cost: 200, reqSecu: 10, attack: 2, info: "일반 창" },
  { code: "S_halberd", name: "극", category: "weapon", cost: 400, reqSecu: 20, attack: 3, info: "강력한 극" },
  { code: "S_blade", name: "도", category: "weapon", cost: 800, reqSecu: 30, attack: 5, info: "날카로운 도" },
  { code: "S_bow", name: "궁", category: "weapon", cost: 600, reqSecu: 25, attack: 4, info: "정교한 궁" },
  { code: "S_greatsword", name: "대검", category: "weapon", cost: 1500, reqSecu: 50, attack: 7, info: "명검" },
  { code: "S_fang_tian", name: "방천화극", category: "weapon", cost: 3000, reqSecu: 70, attack: 10, info: "전설의 방천화극" },
  { code: "S_green_dragon", name: "청룡언월도", category: "weapon", cost: 3000, reqSecu: 70, attack: 10, info: "관우의 청룡언월도" },
  { code: "S_double_sword", name: "쌍검", category: "weapon", cost: 2000, reqSecu: 60, attack: 8, info: "쌍검" },
  // 서적
  { code: "B_basic", name: "맹덕신서", category: "book", cost: 200, reqSecu: 10, intel: 2, info: "기본 병서" },
  { code: "B_art_of_war", name: "손자병법", category: "book", cost: 1000, reqSecu: 40, intel: 5, info: "손무의 병법서" },
  { code: "B_36", name: "삼십육계", category: "book", cost: 800, reqSecu: 35, intel: 4, info: "36가지 계략" },
  { code: "B_taigong", name: "태공병법", category: "book", cost: 1500, reqSecu: 50, intel: 7, info: "태공망의 병법" },
  { code: "B_dunjia", name: "둔갑천서", category: "book", cost: 3000, reqSecu: 70, intel: 10, info: "전설의 도술서" },
  { code: "B_politics", name: "논어", category: "book", cost: 500, reqSecu: 20, intel: 3, info: "정치의 기본서" },
  // 명마
  { code: "H_basic", name: "산마", category: "horse", cost: 200, reqSecu: 10, speed: 1, info: "기본 말" },
  { code: "H_fast", name: "비전마", category: "horse", cost: 500, reqSecu: 25, speed: 2, info: "빠른 전마" },
  { code: "H_red_hare", name: "적토마", category: "horse", cost: 3000, reqSecu: 70, speed: 5, info: "전설의 적토마" },
  { code: "H_shadow", name: "절영", category: "horse", cost: 2000, reqSecu: 60, speed: 4, info: "그림자처럼 빠른 말" },
  { code: "H_storm", name: "적로", category: "horse", cost: 1500, reqSecu: 50, speed: 3, info: "유비의 적로" },
  // 특수
  { code: "I_shield", name: "방패", category: "item", cost: 300, reqSecu: 15, defence: 2, info: "기본 방패" },
  { code: "I_armor", name: "갑옷", category: "item", cost: 800, reqSecu: 35, defence: 4, info: "튼튼한 갑옷" },
  { code: "I_jade", name: "옥쇄", category: "item", cost: 2000, reqSecu: 60, leadership: 3, info: "전국옥쇄" },
  { code: "I_wine", name: "두강주", category: "item", cost: 100, reqSecu: 0, info: "사기 회복용 술" },
];
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-md bg-amber-900/20 border border-amber-800/40 px-3 py-2 text-xs text-amber-200/90">
        ...
        <div className="mt-1 flex gap-3">
          <span>치안: <strong>{currentSecu.toLocaleString()}</strong></span>
          <span>자금: <strong className="text-amber-300">{currentGold.toLocaleString()}금</strong></span>
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex justify-between">
                    <span>{emoji} {label}: {ownedItem ? ownedItem.name : isEmpty ? "없음" : ownedCode}</span>
                    {ownedItem && (
                      <span className="text-green-400">{Math.floor(ownedItem.cost / 2).toLocaleString()}금</span>
                    )}
                  </div>
                </button>
              );
