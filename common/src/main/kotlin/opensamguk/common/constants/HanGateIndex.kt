...
object HanGateIndex {
    val keysByCityId: Map<Int, Set<String>> = mapOf(
        ...
        565 to setOf("揚州"),
        566 to setOf("揚州"),
        567 to setOf("南中", "益州", "蠻"),
        568 to setOf("巴", "益州", "賨"),
        569 to setOf("巴", "巴西", "益州"),
        570 to setOf("巴", "益州", "賨"),
        571 to setOf("巴", "益州", "賨"),
        572 to setOf("巴", "益州", "賨"),
        573 to setOf("巴", "益州", "賨"),
