...
internal data class QueuedStratagemAction(val requestId: String, val ownerUserId: Int,
    ...
    companion object {
        ...
        fun read(meta: Map<String, Any?>): QueuedStratagemAction? {
            ...
            return QueuedStratagemAction(requestId, owner, inputId, json)
        }
        private fun invalid(): Nothing = throw IllegalArgumentException("invalid queued stratagem")
    }
}

internal class StratagemActionExecutor(private val world: InMemoryTurnWorld, private val recorder: ChangeRecorder,
