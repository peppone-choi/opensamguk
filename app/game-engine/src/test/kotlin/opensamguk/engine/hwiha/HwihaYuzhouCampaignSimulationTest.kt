...
class HwihaYuzhouCampaignSimulationTest {
    ...
    private val bundle = HanWorldArtifactsResolver(repo).artifacts(HanWorldVariant.V3_1168)
    ...
    private fun campaign(npcDeploy: Boolean = true): Campaign {
        ...
        val state = TurnWorldState(1, 190, 1, 3600, Instant.parse("0190-01-01T00:00:00Z"), currentPhase = 1,
            config = mapOf("ruleProfile" to "HWIHA", "mapName" to "han-world-v3"), hanWorldVariant = HanWorldVariant.V3_1168,
