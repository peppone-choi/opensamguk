...
class MapAdministrativeOwnershipTest {
    ...
    fun `all canonical scenarios cover every spatial administrative unit exactly once`() {
        ...
        scenarioCodes.forEach { scenarioCode ->
            ...
            assertEquals(1_430, snapshot.provinceOccupancy.size, "scenario $scenarioCode provinces")  // 2026-09-23 결손 縣 56곳: 省 1,374 → 1,430
            ...
            // 2026-09-23: 결손 縣 56곳이 제 관할을 받아 1,168 → 1,224.
            assertEquals(1_224, snapshot.jurisdictionOwnership.size, "scenario $scenarioCode jurisdictions")
