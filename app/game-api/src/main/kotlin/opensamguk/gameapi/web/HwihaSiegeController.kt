...
import opensamguk.gameapi.read.HwihaSiegeReader
...
/** 공성 조회(읽기 전용). 인증 규칙은 [HwihaCampController] 와 같다: 401(principal 없음) · 403(남의 장수) · 200 + status. */
@RestController
class HwihaSiegeController(private val reader: HwihaSiegeReader) {
