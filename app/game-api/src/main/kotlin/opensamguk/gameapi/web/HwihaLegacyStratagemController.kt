...
import opensamguk.gameapi.precheck.HwihaLegacyStratagemOptionsService
...
@RestController
class HwihaLegacyStratagemController(private val reserve: CommandReserveService,
    private val options: HwihaLegacyStratagemOptionsService) {
    ...
    fun submit(@AuthenticationPrincipal userId: Long?, @PathVariable name: String,
        ...
        return try {
          ...
          catch (denied: HwihaAdmissionDenied) { ResponseEntity.ok(mapOf("status" to "BLOCKED", "code" to denied.code,
