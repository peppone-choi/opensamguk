...
class event_상병연구(general: General, env: CommandEnv, arg: Map<String, Any>? = null)
    : NationCommand(general, env, arg) {

    override val actionName = "상병 연구"

    override val fullConditionConstraints = listOf(
        OccupiedCity(), BeChief(),
        ReqNationAuxValue("can_상병사용", 0, "<", 1, "${actionName}가 이미 완료되었습니다."),
