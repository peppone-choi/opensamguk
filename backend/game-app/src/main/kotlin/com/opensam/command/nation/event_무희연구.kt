...
class event_무희연구(general: General, env: CommandEnv, arg: Map<String, Any>? = null)
    : NationCommand(general, env, arg) {

    override val actionName = "무희 연구"

    override val fullConditionConstraints = listOf(
        OccupiedCity(), BeChief(),
        ReqNationAuxValue("can_무희사용", 0, "<", 1, "${actionName}가 이미 완료되었습니다."),
