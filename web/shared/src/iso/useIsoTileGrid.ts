...
export interface IsoMapData {
   ...
   * 실측(han-world-v3, 781 城 시절): 게임 도시 781 중 773 이 이 길로 좌표를 얻고 충돌은 0 이다.
   * 2026-09-11 변경 縣 51 곳이 城 782–832 로 서면서 provinceId 가 붙었고, 2026-09-12 城 없던
   * 郡治 3 곳(833–835)이 섰다. 폴백은 郡 직할 땅에 선 네 곳(704·833–835)이 쓴다.
