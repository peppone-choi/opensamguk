                ...
                {courtMode ? (profile === 'HWIHA' ? <CourtForm key={generalId} generalId={generalId} refreshKey={refreshKey} onReserved={onReserved} /> : <p role="status">서버 규칙을 확인하지 못해 발령을 입력할 수 없습니다.</p>) : profile === 'HWIHA' ? (
                    <>
                        ...
                        {(pinnedCommand || selectedAction) === 'action.deploy' ?
                            ...
                            <TravelForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as TravelActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isFieldActionId(pinnedCommand || selectedAction) ?
                            <FieldForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').FieldActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isMilitaryActionId(pinnedCommand || selectedAction) ?
                            <MilitaryForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').MilitaryActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isPersonalActionId(pinnedCommand || selectedAction) ?
                            <PersonalForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').PersonalActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isPeopleActionId(pinnedCommand || selectedAction) ?
                            <PeopleForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').PeopleActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isPoliticalActionId(pinnedCommand || selectedAction) ?
                            <PoliticalForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').PoliticalActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isTransferActionId(pinnedCommand || selectedAction) ?
                            <TransferForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').TransferActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
                            isLegacyDirectActionId(pinnedCommand || selectedAction) ?
                            <DirectActionForm key={`${pinnedCommand || selectedAction}:${generalId}:${refreshKey ?? ''}`} inputId={(pinnedCommand || selectedAction) as import('../lib/types').DirectActionId} generalId={generalId} turnIdx={turnIdx} refreshKey={refreshKey} unavailable={!!isNationCommand} onToast={onToast} onClose={onClose} onReserved={onReserved} /> :
