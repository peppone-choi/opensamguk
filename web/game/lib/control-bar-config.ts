...
export const CONTROL_BUTTONS: ControlButton[] = [
    { id: 1, label: '회 의 실', compactLabel: '회의실', href: `${STUB}?feature=${encodeURIComponent('회의실')}`, bucket: 'myLevel' },
    { id: 2, label: '기 밀 실', compactLabel: '기밀실', href: `${STUB}?feature=${encodeURIComponent('기밀실')}`, bucket: 'permission2' },
    { id: 3, label: '부대 편성', compactLabel: '부대 편성', href: `${STUB}?feature=${encodeURIComponent('부대 편성')}`, bucket: 'myLevelAndNation' },
    ...
    { id: 6, label: '내 무 부', compactLabel: '내무부', href: '/game/nation?tab=finance', bucket: 'showSecret' },
    { id: 7, label: '사 령 부', compactLabel: '사령부', href: '/game/nation?tab=chief', bucket: 'showSecret' },
    { id: 8, label: 'NPC 정책', compactLabel: 'NPC 정책', href: '/game/nation?tab=npc', bucket: 'showSecret' },
    ...
    { id: 14, label: '중원 정보', compactLabel: '중원 정보', href: '/game/diplomacy?view=global', bucket: 'always' },
    ...
    { id: 17, label: '유산 관리', compactLabel: '유산 관리', href: `${STUB}?feature=${encodeURIComponent('유산 관리')}`, bucket: 'always' },
