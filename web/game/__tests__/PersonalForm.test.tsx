...
import PersonalForm from '../components/command/PersonalForm';
...
test('travel sends no client selected actor or location',async()=>{
    ...
    render(<PersonalForm {...props} inputId="action.travel"/>);
...
test('healthy actor cannot reserve recuperation',async()=>{
    ...
    render(<PersonalForm {...props} inputId="action.recuperate"/>);
...
test('retirement submits the chosen successor from server options',async()=>{
    ...
    render(<PersonalForm {...props} inputId="action.retire"/>);
