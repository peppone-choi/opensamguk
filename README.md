...
구성됩니다. 새 설계에서는 한 명의 장수에서 시작해 주공을 섬기거나 스스로 주공이 되어 휘하, 국가, 작전, 전쟁을
운영하는 방향으로 전환하고 있으며, 아직 구현 전입니다.
...
| 명령 체계 | 재설계 방향 확정, 구현 전 | 기존 명령을 장수 행동·배치·방침·공사·계책·조정 결정으로 교체 ([재설계 문서](docs/superpowers/specs/2026-09-17-general-and-retinue-campaign-redesign.md)) |
