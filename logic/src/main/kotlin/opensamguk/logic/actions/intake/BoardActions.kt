...
object BoardActions {
    ...
    sealed interface ArticleOutcome {
        ...
        data class Insert(val isSecret: Boolean, val title: String, val text: String) : ArticleOutcome
    }
     ...
     */
    fun addArticle(isSecret: Boolean, rawTitle: String?, rawText: String?, permission: Int): ArticleOutcome {
        ...
        return ArticleOutcome.Insert(isSecret, title, text)
    }
