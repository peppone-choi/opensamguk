...
enum class EventKind(
    ...
    RENOWN_EVENT("renown.event", PERSONAL, setOf(SELF), allowedRefs = setOf(ACTOR, CITY), allowedFacts = setOf(CHANGE)),
    YUEDAN_ASSESSED("yuedan.assessed", PERSONAL, setOf(SELF), allowedRefs = setOf(ACTOR), allowedFacts = setOf(AMOUNT)),
    ...
    INCOME_MONTHLY("income.monthly", RETINUE_NATION, setOf(EventAudience.NATION), allowedRefs = setOf(NATION), allowedFacts = setOf(AMOUNT)),
