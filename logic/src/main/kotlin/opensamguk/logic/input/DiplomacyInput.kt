...
data class HwihaDiplomacyRequest(val actorId: Int, val inputId: String, val targetNationId: Int)

/** Four legacy diplomatic proposals share the envoy and target-nation gate at execution. */
object HwihaDiplomacyInput {
    ...
    fun parse(actorId: Int, inputId: String, rawJson: String?): HwihaDiplomacyRequest? {
        ...
        return try {
            ...
            HwihaDiplomacyRequest(actorId, inputId, id)
        } catch (_: IllegalArgumentException) { null }
    }

    fun canonicalJson(request: HwihaDiplomacyRequest): String {
