...
data class HwihaTravelRequest(val actorId: Int, val inputId: String, val destination: StrategicNodeRef.LandProvince?)

object HwihaTravelInput {
    ...
    fun parse(actorId: Int, inputId: String, rawJson: String?): HwihaTravelRequest? {
        ...
        return try {
            ...
            if (inputId == RETURN) {
                ...
                HwihaTravelRequest(actorId, inputId, null)
            } else {
                ...
                HwihaTravelRequest(actorId, inputId, StrategicNodeRef.LandProvince(raw.content))
            }
        } catch (_: IllegalArgumentException) { null }
    }

    fun canonicalJson(request: HwihaTravelRequest): String {
