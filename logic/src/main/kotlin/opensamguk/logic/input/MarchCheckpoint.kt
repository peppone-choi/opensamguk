...
data class MarchCheckpoint(
    ...
    companion object {
        ...
        fun read(raw: Any?, topology: StrategicTopologySnapshot, metrics: LandMarchMetricSnapshot): MarchCheckpoint {
            ...
            val checkpoint = MarchCheckpoint(path, LandMarchCursor(path.pathHash, index, paid),
                Phase.read(value["lastAdvancedAt"]), LandMarchStop.valueOf(value["stop"] as? String ?: invalid()))
