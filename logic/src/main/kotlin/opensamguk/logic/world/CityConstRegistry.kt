...
import opensamguk.common.constants.HanWorldV31097CityConst
import opensamguk.common.constants.HanWorldV31097GateIndex
...
private val historicalHanWorlds: Map<HanWorldVariant, CityConstVariant> by lazy {
    mapOf(
        ...
        HanWorldVariant.V3_1097 to HanCityConstVariant(
            HAN_WORLD_V3_MAP_NAME, HanWorldV31097CityConst.initCity, HanWorldV31097GateIndex::keys,
            nationLevelCityThresholds = listOf(0, 1, 5, 12, 20, 27, 40, 52, 70, 90),
        ),
