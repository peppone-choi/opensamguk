...
*New page vs `legacy/hwe/b_myBossInfo.php` + `legacy/hwe/ts/bossInfo.ts`*
...
*New page vs legacy internal affairs (nation policy PHP, scattered across multiple files)*
...
*New page vs `legacy/hwe/ts/v_troop.ts` + `legacy/hwe/ts/extPluginTroop.ts` + `legacy/hwe/ts/PageTroop.vue`*
...
*New page vs legacy spy/scout PHP (scattered: ScoutMessage.php, SetScoutMsg.php, SetBlockScout.php)*
...
*New page vs `legacy/hwe/a_traffic.php`*
...
*New page vs `legacy/hwe/ts/PageNPCControl.vue` + `legacy/hwe/ts/v_NPCControl.ts`*
...
*New page vs `legacy/hwe/b_genList.php`*
...
*New page vs `legacy/hwe/ts/v_main.ts` + `legacy/hwe/ts/v_front.ts` + `legacy/hwe/ts/PageFront.vue`*
