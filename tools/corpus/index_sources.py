...
용법:
    ...
    python3 tools/corpus/index_sources.py 連弩 --book 華陽國志
    python3 tools/corpus/index_sources.py 突騎 --era           # 삼국지 시대(184~280) 사서만
"""
import argparse, glob, os, re, sqlite3, sys

HOME = os.environ.get('SHILIAO_HOME') or ('data/corpus' if os.path.isdir('data') else os.path.expanduser('~/.shiliao'))
