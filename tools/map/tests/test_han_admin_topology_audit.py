...
class HanAdminTopologyAuditTest(unittest.TestCase):
    ...
    def test_canonical_snapshot_is_current_and_complete(self) -> None:
        ...
        self.assertEqual(30, snapshot["provinceTopology"]["disconnectedCount"])
        ...
        self.assertEqual(0, snapshot["provinceTopology"]["fullyEnclosedCount"])
        ...
        self.assertEqual(9, snapshot["commanderyTopology"]["fullyEnclosedCount"])
