...
INPUT_ROLES = [
    ...
    "JURISDICTION_SEAT_RECOVERIES", "JURISDICTION_PARENT_ADJUDICATIONS",
]
GENERATOR_ROLES = [
...
class WaterOverlayBaseContractTest(unittest.TestCase):
    ...
    def test_committed_han_tiles_binding_matches_the_expected_baseline(self):
        ...
        self.assertEqual(
            ...
            "ec9970ee181c7089b87a62bece57d277b4ae760111d755b5eb14ba2debf91312",  # 2026-09-23: 결손 縣 56곳 · 郡 오귀속 2건
            binding["sha256"],
        )
        self.assertEqual((768, 669), (binding["cols"], binding["rows"]))
        self.assertEqual(1_653, len(binding["landProvinceIds"]))  # 결손 縣 223곳 추가 후
