...
EXEMPT = {
    "tools/map/build_han_1341_bundle.py": "Withdrawn roster remains frozen for compatibility; current drift uses 1194.",
    "tools/map/build_han_1141_bundle.py": "Frozen prior release, integrity checked by Kotlin tests; latest drift uses 1194.",
    "tools/map/repin_han_1133_bundle.py": "Historical release repin utility; frozen integrity tested by Han1133ArtifactsIntegrityTest and HanRuntimeConstantsIntegrityTest. Latest drift uses 1194.",
