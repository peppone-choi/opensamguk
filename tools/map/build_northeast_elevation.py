...
--check verifies retained cells, current dimensions, PNG pins, and DEM levels
...
def main():
 ...
 t=json.loads((ROOT/'data/map/han-tiles.json').read_text());p=t['_meta']['projection'];out=ROOT/'web/game/public/map/elevation';old=np.array(Image.open(out/BASE),dtype=np.int32)-32768
 if args.check:
