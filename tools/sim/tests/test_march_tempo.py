...
class MarchTempoTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.world = json.loads(M.WORLD.read_text(encoding="utf-8"))
        cls.graph = M.Graph(cls.tiles)
        cls.rows = M.table(cls.tiles, cls.world)
    ...
    def test_every_route_is_reachable_and_deterministic(self):
        ...
        self.assertEqual(self.rows, M.table(self.tiles, self.world))
    ...
    def test_homonym_county_names_are_rejected(self):
