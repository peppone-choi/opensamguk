...
class RuntimeProvinceFillAuditTest(unittest.TestCase):
    def test_repository_runtime_fill_debt_does_not_regress_with_city_expansion(self):
        ...
        baseline = [
                ...
                (1020, 643, 448, 202, 10, 4, 0),
                (1021, 661, 460, 211, 13, 2, 0),
                (1030, 789, 538, 259, 11, 4, 0),
                (1031, 850, 578, 279, 10, 6, 0),
                (1040, 797, 546, 257, 9, 4, 0),
                (1041, 881, 602, 286, 10, 5, 0),
                (1050, 1003, 677, 330, 7, 3, 1),
                (1060, 1003, 677, 330, 7, 5, 1),
                (1070, 1038, 723, 319, 7, 2, 1),
                (1080, 1137, 780, 362, 8, 2, 1),
                (1090, 1305, 816, 492, 5, 3, 1),
                (1100, 1306, 825, 484, 5, 2, 1),
                (1110, 1306, 825, 484, 5, 2, 1),
                (1120, 394, 307, 99, 15, 3, 0),
            ]
