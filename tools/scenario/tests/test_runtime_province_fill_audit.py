    ...
    def test_repository_runtime_fill_debt_is_pinned_for_all_scenarios(self):
        ...
        self.assertEqual(
            [
                ...
                (1020, 644, 449, 202, 7, 4, 0),
                (1021, 662, 461, 211, 10, 2, 0),
                (1030, 790, 539, 259, 8, 4, 0),
                (1031, 851, 579, 279, 7, 6, 0),
                (1040, 798, 547, 257, 6, 4, 0),
                (1041, 882, 603, 286, 7, 5, 0),
                (1050, 1005, 679, 330, 4, 3, 0),
                (1060, 1005, 679, 330, 4, 5, 0),
                (1070, 1038, 723, 319, 4, 2, 0),
                (1080, 1137, 780, 362, 5, 2, 0),
                (1090, 1305, 816, 492, 3, 3, 0),
                (1100, 1306, 825, 484, 3, 2, 0),
                (1110, 1306, 825, 484, 3, 2, 0),
                (1120, 395, 308, 99, 12, 3, 0),
            ],
            actual,
        )
