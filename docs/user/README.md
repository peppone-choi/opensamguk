...
- 현재 v1은 PHP 원작을 토대로 만들어졌지만, 2026-08-20 ADR-LITE-042 이후 PHP는 제품 설계의 절대 정답이
  아니라 참고 자료입니다.
- 기존 골든은 삭제하지 않고 frozen baseline 회귀 검증으로 사용합니다.
- 후한 군현 175군·780성 전환은 v1에 승인된 목표이지만 구현 완료를 뜻하지 않습니다. v2의 실시간 대형
  전투와 도시·인맥 중심 플레이는 [기획 로드맵](../design/roadmap.md)에 있으며 현재 기능처럼 설명하지 않습니다.
