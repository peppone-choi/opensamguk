...
지도 관련 #460·#462·#463에는 아이소메트릭 표현과 남은 작업이 섞여 있다. 이들은 삼모 명령 기능 이슈가 아니며 `hwiha-map-unify`의 iso 지도 삭제·메인 지도 통일 결과가 아직 main에 없어서 이 감사에서 상태를 바꾸지 않았다. 지도 통일이 병합되면 남은 2D 지도 기능·에셋 요구를 대조해 완료 또는 별도 후속으로 정리해야 한다.
