...
- Bounded cache bytes and decoded pixels and rejected unsafe cache entries.
...
- Python unit suite: 37 tests, 0 failures.
...
- Terminal security review: `CLEARED`; exact 37/37, nested encoding, cache and
