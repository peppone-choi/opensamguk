...
- ⬜ **P6 P7-coupled remainder** — `AuctionExpiryDaemon`, `PlaceBet` command/handler, betwin/betwingold rank updates, messaging accept/decline API endpoints, game-api read controllers for auction/betting/mailbox.
...
- ⬜ **P7** read API + Next.js + SSE — dedicated REST controllers for auction/betting/message/mailbox, `GetDiplomacy.php` neutral-map masking, frontend pages (`web/game/app/game/`).
