 ...
 */
object HwihaScenarioUnits {
    private val fields = setOf("general", "name", "troops", "crewTypeId", "training", "morale", "provisions")

    fun decode(root: Map<String, Any?>, profile: RuleProfile?): List<HwihaScenarioUnit> {
        ...
        return rows.map { raw ->
            ...
            HwihaScenarioUnit(text("general"), text("name"), int("troops"), int("crewTypeId"), int("training"),
