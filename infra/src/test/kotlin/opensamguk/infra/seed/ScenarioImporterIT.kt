 ...
 *
 * Asserts the V3 seed counts (`world_state`=1, `nation`=2, `city`=1228, `general`=230,
...
class ScenarioImporterIT {
    ...
    fun `importAll seeds the A-minimal world with the expected row counts`() {
        ...
        assertEquals(1228, count("city"))
        assertEquals((1..1194).filterNot { it in setOf(1143, 1148, 1157, 1159, 1160, 1161, 1162, 1163, 1164, 1178, 1179, 1180, 1181, 1182, 1183, 1184, 1185, 1186, 1187, 1188, 1189, 1190, 1191, 1192, 1193, 1194) }, jdbc.queryForList("SELECT id FROM city ORDER BY id", Int::class.java))
    ...
    fun `importAll seeds scenario_1030 (군웅할거, 21 nations) without error`() {
        ...
        assertEquals(1228, counts.city)            // Versioned Han V3 catalog, owned and neutral cities.
