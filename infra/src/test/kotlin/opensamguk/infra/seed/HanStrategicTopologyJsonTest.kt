...
class HanStrategicTopologyJsonTest {
    ...
    fun `validated presentation exposes exact isolated water cells without inferred connections`() {
        ...
        assertEquals("99829b28075ec06e835f6f66d4233f5030a9b201a4184348ec282900afc67f09",
    ...
    fun `committed topology keeps stable land identities and resolves Lu to Licheng over dry ground`() {
        ...
        assertEquals(1430, topology.landProvinceIds.size)  // 2026-09-23 결손 縣 56곳(#): 省 1,374 → 1,434
        ...
        assertEquals(1224, loaded.bindingsByCityId.size)
        ...
        assertEquals("DIRECT-PARENT-0171-59e3d2566940", loaded.bindingsByCityId.getValue(704).landProvinceId)
