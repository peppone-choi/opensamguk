...
| Agent | Task | Branch/worktree | Owned files | Status | Updated at |
|---|---|---|---|---|---|
| `cqrs-hardening-root` | OPENSAM-116 W0→W5 orchestration; active OPENSAM-126 | `codex/op-126-scoped-schema` | `.ai/*` | active — strict V31 stack implemented, independently cleared, fully verified, and approved for landing | 2026-07-20 |
