...
- Amendment (2026-09-26, 사용자 결정 — 프론트 전면 재구축, ADR-LITE-065·066 정합): 전 화면 감사(메타
  ...
  - **경로:** 6묶음 기준 새 경로를 쓴다. 옛 경로는 ADR-066 허용 목록 방식의 308 리다이렉트 전용이다.
  ...
  - Supersedes: 위 「삭제」 항목, 로드맵 「세계와 지도」의 「화면의 정본은 야전 사령부 시안 19장이다」 문장.
  - Approved by: 사용자 (2026-09-26, 감사 보고서 §7 결정 1–7 「추천대로」, 모바일 작전실 「추천대로」).
...
- Amendment (2026-09-26, 사용자 결정 — 용어 교체): 상위 개념 「휘하」를 **부(府)** 로 바꾼다. 부는 장수가 거느린
  ...
  **군부**(태수) → **주부**(자사·주목) → **장군부**(개부할 수 있는 장군호) → **공부**(삼공) → **승상부**(승상). 어느 자리가 어느 부를
  ...
  - 근거: 「幕府董統鷹揚」(三國志 卷06 袁紹傳), 「傕又遷車騎將軍，開府」(後漢書 卷072 董卓列傳), 「開府治事」(三國志 卷35 諸葛亮傳),
    ...
    「幕下」는 정사에서는 확인되지 않지만 연의에 있다(「肅乃引孔明至幕下」 三國演義 第43回 — 막부 안이라는 장소의 뜻). 연의도
    사료로 쓰므로(ADR-LITE-057) 우리말에서 굳은 「누구의 막하」라는 소속 표시로 쓴다.
  - 표기: 「휘하 편성」 → 「(이름)의 막부」 편성, 「조조 휘하」(소속 표시) → 「조조 막하」, 기록 분류 「휘하·세력」(ADR-LITE-069) →
    「부·세력」. 「부가 겹친다」 — 장수가 주공의 부에 들면 그 장수의 부곡·부장·보물도 딸려 간다.
  - 용어 풀이: 막하·막부·군부·주부 같은 옛말과 순·구역·명망·결속 같은 게임 용어는 화면에서 점선 밑줄을 긋고, 누르면 게임 안에서의 뜻을
    짧게 보인다(모바일은 하단 시트, 호버 전용 금지). 풀이에는 사료 인용을 넣지 않는다. 도움말에 용어 사전을 두고 튜토리얼 첫 단계에서 한 번 짚는다.
