...
| 스킬                     | 설명                                                                                                         | 커버 파일 패턴                                                                                                                                                                                                                                                                                                                           |
| ------------------------ | ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `verify-entity-parity`   | Entity/Type/Schema 정합성, 5-stat, 필드 네이밍 검증                                                          | `backend/src/main/kotlin/com/opensam/entity/*.kt`, `frontend/src/types/index.ts`, `backend/src/main/resources/db/migration/*.sql`                                                                                                                                                                                                        |
| `verify-command-parity`  | 레거시 PHP 93개 커맨드(55 장수 + 38 국가) 구현 상태 추적                                                     | `backend/src/main/kotlin/com/opensam/command/**/*.kt`, `backend/src/main/kotlin/com/opensam/controller/CommandController.kt`, `backend/src/main/kotlin/com/opensam/service/CommandService.kt`, `backend/src/main/kotlin/com/opensam/dto/CommandDtos.kt`, `frontend/src/components/command/*.tsx`, `docs/architecture/legacy-commands.md` |
| `verify-resource-parity` | 레거시 게임 리소스(시나리오, 맵, 도시, 관직, 병종) 존재 확인                                                 | `backend/src/main/resources/data/**/*`, `legacy/hwe/sammo/CityConstBase.php`, `legacy/hwe/sammo/Scenario.php`                                                                                                                                                                                                                            |
| `verify-logic-parity`    | core2026/레거시 대비 게임 로직 동일 결과 확인 (같은 입력 → 같은 출력)                                        | `backend/src/main/kotlin/com/opensam/command/**/*.kt`, `backend/src/main/kotlin/com/opensam/engine/**/*.kt`, `docs/architecture/legacy-engine*.md`                                                                                                                                                                                       |
| `verify-game-tests`      | 백엔드 게임 엔진 테스트 존재/통과 확인, core2026 테스트 참조                                                 | `backend/src/test/kotlin/com/opensam/**/*.kt`, `core2026/packages/logic/src/**/__tests__/*.test.ts`                                                                                                                                                                                                                                      |
| `verify-frontend-parity` | 레거시 PHP/SPA plan 대비 프론트엔드 페이지 수, 출력 정보, UI 구성 확인                                       | `frontend/src/app/**/*`, `frontend/src/components/**/*`, `docs/architecture/game-frontend-spa-plan.md`                                                                                                                                                                                                                                   |
| `verify-docs-parity`     | docs/architecture 문서 의도 대비 구현 반영 확인 (기술스택 차이 허용)                                         | `docs/architecture/*.md`, `backend/src/main/kotlin/com/opensam/**/*.kt`, `frontend/src/**/*`                                                                                                                                                                                                                                             |
| `verify-daemon-parity`   | NPC AI와 턴 데몬이 레거시/docs 대로 동작하는지 확인                                                          | `backend/src/main/kotlin/com/opensam/engine/**/*.kt`, `backend/src/main/kotlin/com/opensam/ai/**/*.kt`, `backend/src/main/kotlin/com/opensam/controller/RealtimeController.kt`, `backend/src/main/kotlin/com/opensam/controller/NpcPolicyController.kt`, `docs/architecture/turn-daemon-lifecycle.md`                                    |
| `verify-npc-data`        | 시나리오 NPC 장수 삼국지14 기준 5-stat(통무지정매) 최신화 확인                                               | `legacy/hwe/scenario/scenario_*.json`, `삼국지14 무장정보.xlsx`, `backend/src/main/resources/data/scenarios/`                                                                                                                                                                                                                            |
| `verify-architecture`    | 백엔드 TDD/DDD/클린-레이어드 아키텍처, 레포지토리 패턴 준수 검증                                             | `backend/src/main/kotlin/com/opensam/{controller,service,repository,entity,dto}/**/*.kt`, `backend/src/test/kotlin/com/opensam/**/*.kt`                                                                                                                                                                                                  |
| `verify-api-parity`      | 풀스택 1:1 메서드-레벨 패러티 (Controller-Service-Repo 체인, FE API-BE 엔드포인트, 스텁/데드코드, 타입 호환) | `backend/src/main/kotlin/com/opensam/controller/*.kt`, `backend/src/main/kotlin/com/opensam/service/*.kt`, `frontend/src/lib/gameApi.ts`, `frontend/src/app/(game)/*/page.tsx`, `frontend/src/types/index.ts`                                                                                                                            |
| `verify-type-parity`     | FE TypeScript 타입 ↔ BE Kotlin DTO/Entity 간 strict 타입 매칭 검증                                           | `frontend/src/types/index.ts`, `frontend/src/lib/gameApi.ts`, `backend/src/main/kotlin/com/opensam/dto/*.kt`, `backend/src/main/kotlin/com/opensam/entity/*.kt`, `backend/src/main/kotlin/com/opensam/controller/*.kt`                                                                                                                   |
